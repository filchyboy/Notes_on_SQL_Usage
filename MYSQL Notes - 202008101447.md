...
Explicit joins are a convention in the language. While implicit joins are possible whenever the programmer chooses it's understood that explicit joins are best. Hence the conventions of `JOINS` `ON`. 
